      ...
      <div className="h-full w-full bg-black/70 absolute top-0 right-0 backdrop-blur-sm flex flex-col justify-center items-center">
        ...
        <div className="mt-8 flex flex-row gap-12">
          <a
            ...
            className="border-2 border-white bg-transparent rounded-[40px] px-4 py-2 text-xl font-bold"
          >
            Get Resume
          </a>
          <button className="border-2 border-white bg-transparent rounded-[40px] px-4 py-2 text-xl font-bold">
            Contact
          </button>
        </div>
      </div>
